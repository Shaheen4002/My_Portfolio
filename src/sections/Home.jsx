    ...
    <section className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 py-12 min-h-[calc(100vh-80px)] px-4 md:px-8">
      <div className="md:w-1/2">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
          {t("Hi, I'm")} <span className="text-primary">{t("Shaheen Sharba")}</span>
        </h1>
        ...
        <div className="flex gap-4">
          <button onClick={scrollToContact} className="btn btn-primary">{t("Contact")}</button>
          <a href="#projects" className="btn btn-outline">{t("View Projects")}</a>
        </div>
      </div>
